...
namespace WebApiTask.Controllers
{
    ...
    public class ColdDrinksController : ControllerBase
    {
        ...
        {
            var coldDrinksNames = _coldDrinksRepo.GetAllColdDrinkNames();
        ...
        {
            var result = _coldDrinksRepo.InsertColdDrink(coldDrink);
            if (result == 0)
            {
        ...
        {
            var result = _coldDrinksRepo.DeleteColdDrinkByName(name);
            if (result == 0)
            {
